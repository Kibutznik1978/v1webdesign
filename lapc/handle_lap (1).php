...
<div class="row">
    <div class="col-md-6 col-md-offset-3 col-xs-10 col-xs-offset-1" >
                ...
                if($highest==$triprig){
                    ...
                    $highestword="Minimum Pay per Duty Period";
                }
                ...
                ?>
                    ...
                    <h3 class="bg-success"><strong>Your Late Arrival Pay will be <?php print"\$$finalresult"?></strong></h3>
                        ...
                        <table class="table table-bordered table-striped">
                          ...
                          <tr>
                            <td>MPDP</td><td><?php print"$mpdp"?></td>
                          </tr>
                        </table>
                ...
                <a href="lap2.php"><button class="btn btn-info btn-lg btn-block" >Back</button></a>
